  ...
  <div class="container h-100">
    <div class="dplay-tbl">
      <div class="dplay-tbl-cell center-text color-white pt-90">
              ...
              <h2 class="mt-30 mb-15">Menu Admin</h2>
      </div><!-- dplay-tbl-cell -->
    </div><!-- dplay-tbl -->
  </div><!-- container -->
</section>
    ...
    <div class="row">
      ...
      <div class="row mb-30">
        <div class="col-md-6">
          <div class="card">
            <div class="bg-white">
              <div class="card-header">Keterangan Tipe</div>
              <ul class="list-group list-group-flush">
                <li class="list-group-item">[1] Savoury</li>
                <li class="list-group-item">[2] Dumpling</li>
                <li class="list-group-item">[3] Desert</li>
                <li class="list-group-item">[4] Drink</li>
              </ul>
            </div>
          </div>
        </div>
